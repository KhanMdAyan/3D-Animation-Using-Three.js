...
function camera_movement(){
    if(score%8==0 && score>0){
        ...
        light_upright.position.y+=160
        light_upleft.position.y+=160
    }
}
...
//creating lights
const light_upleft = new THREE.PointLight( 0xffffff, 6, 4000 );
light_upleft.position.set(-450,-500,500);
scene.add( light_upleft );
const light_upright = new THREE.PointLight( 0xffffff, 4, 4000 );
...
function box_create(){
    ...
    var material_box = new THREE.MeshStandardMaterial();
    window.rancolour=Math.random() * 0xfff0f0;
    material_box.color.setHex(rancolour);
...
function stillbox(){
    ...
    var material_box2 = new THREE.MeshStandardMaterial();
    material_box2.color.setHex(rancolour);
